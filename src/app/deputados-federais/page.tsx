...
export const metadata: Metadata = {
  title: "Ranking de Deputados Federais",
  description:
    "Compare deputados federais por participação, contribuição temática, eficiência, votos públicos e transparência.",
};

export default async function FederalDeputiesPage({
  searchParams,
}: {
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 sm:py-12 lg:px-8">
          <div className="mb-5 max-w-4xl">
            <Badge variant="secondary">Ranking disponível</Badge>
