...
const pendingPath = join(process.cwd(), "src/data/public-vote-classification-pending.json");
const classificationsPath = join(process.cwd(), "src/data/public-vote-classifications.json");
